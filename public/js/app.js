...
bootstrap = __webpack_require__(/*! ../modules/bootstrap/dist/js/bootstrap.bundle.min.js */ "./resources/modules/bootstrap/dist/js/bootstrap.bundle.min.js");

__webpack_require__(/*! ./jquery.maskedinput.min */ "./resources/js/jquery.maskedinput.min.js");

__webpack_require__(/*! alpinejs */ "./node_modules/alpinejs/dist/alpine.js");

(function () {
  'use strict'; // Получите все формы, к которым мы хотим применить пользовательские стили проверки Bootstrap

  var forms = document.querySelectorAll('.needs-validation'); // Зацикливайтесь на них и предотвращайте отправку
...
$(document).ready(function () {
  ...
  $(".theme-edit-btn").on("click", function () {
    var route = $(this).attr("data-route");
    var title = $(this).attr("data-title"); // $("#themeEditModal .modal-title").text(title);
...
ClassicEditor.create(document.querySelector('.editor-text'), {
  toolbar: {
    items: ['heading', '|', 'removeFormat', '|', 'fontColor', 'fontBackgroundColor', '|', 'fontSize', 'bold', 'italic', 'underline', 'strikethrough', 'link', '|', 'bulletedList', 'numberedList', 'alignment', '|', 'outdent', 'indent', '|', 'superscript', 'subscript', 'specialCharacters', '|', 'imageUpload', 'blockQuote', 'insertTable', 'mediaEmbed', 'findAndReplace', 'undo', 'redo', 'horizontalLine', 'code', 'sourceEditing']
  },
  language: 'ru',
  image: {
...
/***/ "./resources/modules/bootstrap/dist/js/bootstrap.bundle.min.js":
/*!*********************************************************************!*\
  !*** ./resources/modules/bootstrap/dist/js/bootstrap.bundle.min.js ***!
  \*********************************************************************/
