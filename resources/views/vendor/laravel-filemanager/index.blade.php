...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('vendor/laravel-filemanager/dops/bootstrap.min.css') }}">
  <link rel="stylesheet" href="{{ asset('vendor/laravel-filemanager/dops/all.css') }}">
  <link rel="stylesheet" href="{{ asset('vendor/laravel-filemanager/dops/jquery-ui.min.css') }}">
...
<body>
  <nav class="navbar sticky-top navbar-expand-lg navbar-dark" id="nav">
    ...
    <div class="ml-auto px-2">
      <a class="navbar-link d-none" id="multi_selection_toggle">
        ...
        <span class="d-lg-inline">{{ trans('laravel-filemanager::lfm.menu-multiple') }}</span>
      </a>
    </div>
  ...
  <script src="{{ asset('vendor/laravel-filemanager/dops/jquery-3.2.1.min.js') }}"></script>
  <script src="{{ asset('vendor/laravel-filemanager/dops/popper.min.js') }}"></script>
  <script src="{{ asset('vendor/laravel-filemanager/dops/bootstrap.min.js') }}"></script>
  <script src="{{ asset('vendor/laravel-filemanager/dops/jquery-ui.min.js') }}"></script>
