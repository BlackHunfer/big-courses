                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop2">
                                        <li><a class="dropdown-item" href="{{ route('materials.create', ['theme' => $theme->id, 'course' => $course->id, 'material_type_id' => 0]) }}">{{ \App\Http\Helper::typeMaterialIdToStr(0)['title'] }}</a></li>
                                        <li><a class="dropdown-item" href="{{ route('materials.create', ['theme' => $theme->id, 'course' => $course->id, 'material_type_id' => 1]) }}">{{ \App\Http\Helper::typeMaterialIdToStr(1)['title'] }}</a></li>
                                        <li><a class="dropdown-item" href="{{ route('materials.create', ['theme' => $theme->id, 'course' => $course->id, 'material_type_id' => 2]) }}">{{ \App\Http\Helper::typeMaterialIdToStr(2)['title'] }}</a></li>
